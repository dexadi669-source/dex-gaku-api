// =====================================================
// kana-data.js
// Berisi SEMUA data huruf Hiragana & Katakana.
// Kalau mau menambah/mengubah huruf, cukup edit array
// di bawah ini. Tidak perlu sentuh file lain.
//
// Setiap baris array = { char: "huruf", romaji: "bacaan" }
// Isi "" pada char untuk membuat sel kosong (spasi kosong
// di grid, misalnya pada baris huruf ya/yu/yo yang tidak
// penuh 5 kolom).
// =====================================================
...
// Label tampilan untuk tiap grup (dipakai di tab & judul kartu)
var KANA_GROUP_LABELS = {
  seion:     { tab: "Seion",     title: "Seion",     desc: "Huruf dasar." },
  dakuon:    { tab: "Dakuon",    title: "Dakuon",     desc: "Huruf dengan tanda ゛(tenten)." },
  handakuon: { tab: "Handakuon", title: "Handakuon",  desc: "Huruf dengan tanda ゜(maru)." },
  yoon:      { tab: "Yoon",      title: "Yoon",       desc: "Huruf gabungan (kombinasi ya/yu/yo kecil)." }
};
